...
<form method="post" action="processEmailHold.php" name="prepareNotices" >
  <table height="621" border="0" cellpadding="2" cellspacing="2" style="text-align: left;">
    <tbody>
      <tr>
        <td colspan="2" rowspan="1"><h2 align="center" class="style1"><span style="font-weight: bold;">Current Holds &amp; Email Notices
    Generator</span></h2>
  ...
  -- family or single patron </p>
        ...
        <td width="418"><p align="center">&nbsp;</p>
          <p><strong>From: </strong><strong>
            <input name="daysAgo1" value= 1 size="8" maxlength="6">
            </strong>Days Ago<strong> To</strong><strong>
            <input name="daysAgo2" value= 1 size="8" maxlength="6">
          </strong> Days Ago</p>
...
<br>
      ...
      <tr>
        ...
        <p>
  <input name="reportType" type="radio" value="shelf" checked>
